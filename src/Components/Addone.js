...
const Addone = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        axios.post(`${baseUrl}/workouts`, data, {
        ...
        .then(response => {
            ...
            {
                setStatus('success');
                setMessage("Successfully Added New Element:");
            } else {
                setStatus('failure');
            }
        })
        .catch(err => {
            console.error(err);
            setStatus('failure');
            setMessage("Failed Adding New Element. Error Message: " + err.response.data.error);
    ...
    return ( 
        <div className="default-body">
            <div className="max-w-4xl w-full space-y-2 text-center border">
                ...
                <hr />
                <div className="py-3">
                    <h2 className="work-h2">Add One</h2>
