   ...
   function changeLoginMode(){
    ...
    return (
        <div id="login" className="flex flex-col items-center bg-night py-24">
            <h2 className="text-white text-4xl sm:text-6xl md:text-7xl lg:text-8xl text-center font-bold max-w-4xl">{formData.isSignUp?"Signup Now to start you fitness routine":"Login to continue your fitness routine"}!</h2>
